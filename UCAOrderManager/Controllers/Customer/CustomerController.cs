...
namespace UCAOrderManager.Controllers.Customer
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,BusinessName,ContactName,EMailID,Address,City,Country,IntPhoneNo,AirportDestCity,IsApproved")] Models.Customer.CustomerViewModel ViewModel)
        {
            if (Common.Props.LoginUser == null)
            {
                return RedirectToAction("Login", "Users", new { ReturnUrl = "/Customer/Create" });
